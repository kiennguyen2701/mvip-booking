...
export default function LoginPage() {
  return (
    <main className="relative flex min-h-[calc(100svh-92px-86px)] w-full max-w-full items-center justify-center overflow-x-hidden bg-[#080704] px-4 py-5 text-white md:min-h-[calc(100svh-96px-86px)] md:px-6 md:py-6">
      ...
      <div className="relative mx-auto flex w-full max-w-[520px] items-center justify-center overflow-x-hidden">
